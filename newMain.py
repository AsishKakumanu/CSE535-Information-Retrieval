...
def search():
    ...
    print(string)
    #string="syria"
    inurl = 'http://localhost:8983/solr/BM25/select?indent=on&indent=on&q=' + urllib.request.pathname2url(
    ...
    i = 0
    result += "<div style=\"float:left; width:30%;\"> <a href='https://en.wikipedia.org/wiki/" + string + "'><h3>" + string.title(
    ) + "</h3></a>"
