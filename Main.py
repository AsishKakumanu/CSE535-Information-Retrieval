...
def search():
    ...
    result+=' placeholder=\''
    result+=string
    result+='\'> <input type="submit" id="button" onclick="myFunction(0)"> <br> <br> <br>'
    i=0
    for doc in docs:
        if 'text_en' in doc:
            ...
            if 1==1:
                ...
                result += 'https://twitter.com/Wonam6/status/'+doc['id']+'</a>'
                result += '<br><p style=\'width:550px;margin-left:5em;margin-left:5em\'>'
